...
public class Knight extends Piece {
    /**
     * The constraint field generator for the Knight.
     */
    private static final ConstraintFieldGenerator CONSTRAINT_FIELD_GENERATOR =
        new ConstraintFieldGenerator()
            .addConstraint(new Constraint(Constraint.Direction.VERTICAL, 2, 2, false)
                .then(new Constraint(Constraint.Direction.HORIZONTAL, 1, 1, false)))
            .addConstraint(new Constraint(Constraint.Direction.HORIZONTAL, 2, 2, false)
                .then(new Constraint(Constraint.Direction.VERTICAL, 1, 1, false)));
